<template>
  <div>
    <header class="content-header">
      <h3 class="header-title">{{ $t(`movie.person`) }}</h3>
            ...
            <table class="table table-hover mb-0">
              ...
              <tbody>
                <tr v-for="(record, index) in records" :key="`record-${index}`">
                  <td>
                    <NuxtLink :to="linkTo(`/movie/collection/view/${record.id}`)" class="font-numeral">{{ record.id }}</NuxtLink>
                  </td>
                  <td>
                    <div class="mb-0">
                  ...
                  <td>
                    ...
                    <div 
                      ...
                      :style="addMoviePosterStyle(record.profile_path, 200)">
                    </div>
                  </td>
                  <td>
                    <div class="mb-0">
