<template>
  <div>
    <header class="content-header">
      <h3 class="header-title">{{ $t(`lottery.forecast`) }}{{ $t(`lottery.slug.${_.get($route, 'params.slug')}`) }}</h3>
    ...
    <LotteryForecast></LotteryForecast>
  </div>
</template>
...
import LotteryForecast from '~/components/Admin/Lottery/Forecast'

export default {
  name: 'LotteryCryptoForecast',
  components: {
    LotteryForecast
  },
  mixins: [fetchMixin],
