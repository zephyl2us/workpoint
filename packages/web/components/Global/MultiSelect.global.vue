...
<script>
import ValueItem from './MultiSelect/ValueItem'
import Editor from './MultiSelect/Editor'
import Close from './MultiSelect/icons/Close'
import Dropdown from './MultiSelect/icons/Dropdown'
