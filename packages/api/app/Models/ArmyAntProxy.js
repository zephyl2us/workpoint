...
const Filter = use('App/Models/Filters/ArmyAntProxyFilter')
const Sorter = use('App/Models/Sorters/ArmyAntProxySorter')
const moment = use('moment')

class ArmyAntProxy extends Model {
  static boot () {
    super.boot()
