...
async function testAVAXFix() {
  try {
    console.log('🔬 Finding Best Decimal Precision for AVAX\n')
    ...
    console.log('📊 Testing Different Decimal Precisions:\n')
    
    // ทดสอบ decimal precision ต่างๆ
    for (let decimals = 3; decimals <= 6; decimals++) {
      ...
      if (parseFloat(percentage) >= 98) {
        console.log(`   ✅ This precision achieves 98%+!`)
      }
    }
